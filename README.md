...
- Understand the boot process and bare-metal execution.
- Design and implement a minimal kernel.
...
- Device interaction (initially minimal)
- Runtime support for a custom language
- Language design and compiler implementation

The project prioritizes understanding and experimentation over performance or completeness.
...
- Explicit control over system behavior  
- Learning-driven development  

Every component exists to be understood, modified, and questioned.
...
It is suitable for developers interested in:
...
Expect incomplete features, breaking changes, and experimental design choices.
